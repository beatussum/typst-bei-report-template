...
> Instead sensitive bugs must be sent by email to [Mattéo Rossillol‑‑Laruelle](mailto:Mattéo%20Rossillol‑‑Laruelle%20<beatussum@protonmail.com>).
...
If you want to notify a _bug_, please use the appropriate template.
...
- Do not start your commit message with a capital letter.
- Prefix with scope (i.e. system or module path): `\`foo::bar\`: fix typo` or `foo/bar.rs: fix typo`.
